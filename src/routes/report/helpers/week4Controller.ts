...
export const week4Question1Responses = (
...
export const week4Question2Responses = (
  responses: SurveyResponse[]
): [string, string, number][] => {
  const options = [
...
export const week4Question3Responses = (
  responses: SurveyResponse[]
): [string, string, number][] => {
  const options = [
...
export const week4Question4Responses = (
  responses: SurveyResponse[]
): [string, string, number][] => {
  const options = [
    "a) Strongly Disagree",
...
export const week4Question5Responses = (
  responses: SurveyResponse[]
): [string, number][] => {
  const options = [
    "a) Poor",
