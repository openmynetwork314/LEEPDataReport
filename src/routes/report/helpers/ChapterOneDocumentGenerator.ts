 ...
 */
    ...
    .thirteenthPageDiv div:nth-child(2) {
        height: 80%;
        display: flex;
        justify-content: space-between;
        align-items: center;
      ...
      <div class="pageWrapper">
        <div class="page">
            <div class="thirteenthPageDiv">
                ...
                <div>
                    <h1> LEEP STUDENT DATA</h1>
                    <h3> NAVIGATING THE NINE BOX</h3>
                </div>

                <div>
                    <img src="${globalImagePath}/nine_box_block.png" width="60%" />

                    <div class="thirteenthPageDiv_Question">
                        <span>What is the LEEP 9 Box?</span>
                        <p>

                            An assessment involves plotting students' scores on two axes categorizing them into
                            different
                            quadrants based on their school engagement and social-emotional learning
                        </p>
                        ...
                        Survey Data + LEEP Teacher observation = 9 Box
     ...
     <div class="pageWrapper">
        <div class="page">
            <div class="thirteenthPageDiv">
                ...
                <div>
                    <h1> LEEP Nine Box Descriptions
                    </h1>
                </div>

                <div class="grid-container">
                    <!-- first box -->
                    <div style="background-color: #bbbbbb;" class="grid-item">
                        <span>
                            C2
                        </span>
                        <p>
                            Low Engagement, High SEL Competence: Despite low engagement, these students display strong
                            social-emotional skills. Understanding their disengagement and addressing it could help them
                    ...
                    <!-- second box -->
                    <div style="background-color: #75bda7;" class="grid-item">
                        <span>
                            B2
                        </span>
                        <p>
                            Moderate Engagement, High SEL Competence: These students show good social-emotional skills
                            but might need more active engagement in school. They could potentially benefit from
                    ...
                    <div style="background-color: #75bda7;" class="grid-item">
                        ...
                        <p>
                            High Engagement, High SEL Competence: These are students who are actively engaged in school
                            and exhibit strong social-emotional skills. They are likely well-adjusted and thriving in
                    ...
                    <!-- fourth box -->
                    <div style="background-color: #80799a;" class="grid-item">
                        <span>
                            C1
                        </span>
                        <p>
                            Low Engagement, Moderate SEL Competence: These students are disengaged and may have moderate
                            social-emotional skills. Exploring the reasons for disengagement and providing targeted
                            support is crucial.
                    ...
                    <!-- fifth box -->
                    <div style="background-color: #ffff00;color:black" class="grid-item">
                        <span>
                            B1
                        </span>
                        <p>
                            Moderate Engagement, Moderate SEL Competence: Students falling here might have a balanced
                            approach to both engagement and social-emotional skills. It's important to monitor their
                            progress and offer support if needed.
                    ...
                    <div style="background-color: #75bda7;" class="grid-item">
                        ...
                        <p>
                            High Engagement, Moderate SEL Competence: These students are engaged in school but might
                            benefit from additional support in developing certain social-emotional skills. They are
                            motivated, but some areas of emotional intelligence might need attention
                    ...
                    <!-- seventh box -->
                    <div style="background-color: #c00001;" class="grid-item">
                        <span>
                            C0
                        </span>
                        <p>
                            Low Engagement, Low SEL Competence: Students in this quadrant face challenges in both school
                            engagement and social-emotional skills. Focusing on improving these aspects can have a
                            positive impact.
                    ...
                    <!-- eighth box -->
                    <div style="background-color: #00aff0;" class="grid-item">
                        <span>
                            B0
                        </span>
                        <p>
                            Moderate Engagement, Low SEL Competence: These students might need assistance in both
                            engagement and social-emotional development. Tailored interventions can help them improve in
                            both areas.
                    ...
                    <!-- ninth box -->
                    <div style="background-color: #266e8b;" class="grid-item">
                        <span>
                            A0
                        </span>
                        <p>
                            High Engagement, Low SEL Competence: While engaged in school activities, these students
                            might struggle with social-emotional skills. It's important to provide guidance and support
                            to help them navigate emotional challenges.
